              ...
              {result.file_url && (
                <div className="mt-6">
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-between p-3 bg-slate-50 border border-slate-200 rounded-2xl hover:border-indigo-300 group transition-all shadow-sm"
                  >
