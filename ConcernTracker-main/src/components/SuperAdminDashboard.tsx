...
export default function SuperAdminDashboard({ user, onLogout, onSettings }: SuperAdminDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Navbar */}
      <nav className="bg-white/80 border-b border-slate-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40 backdrop-blur-xl shadow-sm">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-end gap-2">
                          <button 
                            ...
                            className="px-3 py-1.5 border border-green-200 text-green-700 text-xs font-bold rounded-xl hover:bg-green-50 disabled:opacity-50 transition-colors shadow-sm"
                          >
                          ...
                          <button 
                            ...
                            disabled={!!actionLoading}
                            className="px-3 py-1.5 border border-red-200 text-red-700 text-xs font-bold rounded-xl hover:bg-red-50 disabled:opacity-50 transition-colors shadow-sm"
                          >
