    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-8 shadow-xl">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8 mb-8 sm:mb-10">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-50 rounded-2xl sm:rounded-2xl flex items-center justify-center text-indigo-600 shadow-sm border border-indigo-100 flex-shrink-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <div className="relative group w-full sm:w-80">
            ...
            <input
              ...
              className="bg-slate-50 border border-slate-200 rounded-2xl pl-12 pr-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all w-full shadow-sm"
            />
          </div>
          ...
          <div className="relative w-full sm:w-auto">
            <select
              ...
              className="bg-slate-50 border border-slate-200 rounded-2xl pl-4 pr-10 py-3 text-sm text-slate-900 font-bold focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all appearance-none min-w-[160px] cursor-pointer shadow-sm"
            >
          ...
          {filteredConcerns.map((concern) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <span className="text-[10px] font-black text-indigo-700 uppercase tracking-[0.2em] bg-indigo-50 px-3 py-1.5 rounded-xl border border-indigo-100">
