  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button 
            ...
            className="px-4 py-2 border border-slate-200 text-slate-700 bg-white rounded-xl hover:bg-slate-50 font-medium transition-all flex items-center text-sm disabled:opacity-50 shadow-sm"
          >
          ...
          <button 
            ...
            className="px-4 py-2 border border-slate-200 text-slate-700 bg-white rounded-xl hover:bg-slate-50 font-medium transition-all flex items-center text-sm shadow-sm"
          >
          ...
          <button 
            ...
            className={`px-4 py-2 border ${isFilterPanelOpen ? 'border-indigo-500 bg-indigo-50 text-indigo-600 shadow-sm' : 'border-slate-200 text-slate-700 bg-white hover:bg-slate-50'} rounded-xl font-medium transition-all flex items-center text-sm shadow-sm`}
          >
      ...
      {isFilterPanelOpen && (
        <div 
          ref={filterPanelRef}
          className="mb-8 p-6 bg-white border border-slate-200 rounded-2xl shadow-xl animate-in slide-in-from-top-4 duration-200"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex items-end gap-4">
              <div className="flex-1">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none"
                  >
                    <option>All</option>
              ...
              <button 
                ...
                className="px-6 py-2 border border-slate-200 bg-white text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl text-sm transition-colors shadow-sm"
              >
                Clear Filters
              </button>
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-8 items-stretch">
        ...
        <div className="xl:col-span-4 flex flex-col gap-6">
          {/* Concerns by status */}
          <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full bg-white border border-slate-200 rounded-xl pl-9 pr-3 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all shadow-sm"
              />
            </div>
          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <button 
                            className="px-3 py-1.5 bg-indigo-50 hover:bg-indigo-600 text-indigo-600 hover:text-white rounded-xl text-xs font-bold uppercase tracking-widest transition-all active:scale-95"
                          >
                            Details
                          </button>
                        </td>
